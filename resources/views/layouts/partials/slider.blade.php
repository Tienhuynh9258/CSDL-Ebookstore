<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{ asset('images/book1.jpg') }}" style='width:100%;height:500px'>
    ...
    <div class="carousel-item">
      <img src="{{ asset('images/book2.jpg') }}" style='width:100%;height:500px'>
      <div class="carousel-caption" style='margin-bottom:120px'>
    ...
    <div class="carousel-item">
      <img src="{{ asset('images/book3.jpg') }}" style='width:100%;height:500px'>
      <div class="carousel-caption" style='margin-bottom:120px'>
